...
export const metadata = {
  ...
  keywords: ['dk glass', 'velasco', 'velasco glass', 'glass', 'Residencial', 'Patio Door', 'Patio Enclosure', 'Shower Glass Door', 'Sliding Glass Door', 'Mirrors', 'Railing stairs', 'Storefront', 'Impact Storefront', 'Office Partition', 'Tempered glass', 'velasco'],

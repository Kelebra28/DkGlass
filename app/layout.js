...
export const metadata = {
  ...
  keywords: ['dk glass', 'velasco', 'velasco glass', 'glass', 'dk glass & velasco', 'Residencial', 'Patio Door', 'Patio Enclosure', 'Shower Glass Door', 'Sliding Glass Door', 'Mirrors', 'Railing stairs', 'Storefront', 'Impact Storefront', 'Office Partition', 'Tempered glass', 'velasco', 'Huston', 'Hustom', 'hustom'],
  authors: [{ name: 'Ricardo Basurto' }, { name: 'RPM Code', url: 'https://www.rpmspeedcode.com/' }],

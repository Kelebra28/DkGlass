...
const SideBar = ({ handleClickMenu }) => (
  <div className="fixed top-0 left-0 right-0 bottom-0 z-50">
    <div className="bg-[white] absolute top-0 bottom-0 left-0 right-[70%]">
      <header className="bg-dk-main relative flex flex-col items-end pb-[54px] border-b-dk-secondary border-b-[10px] pt-[12px] pr-[10px]">
        <div onClick={handleClickMenu} className="w-[22px] h-[22px] relative">
          <Image
      ...
      <div className="absolute top-[160px] bottom-0 left-0 right-0 pl-[40px] pr-[30px] overflow-scroll">
    ...
    <div onClick={handleClickMenu} className="bg-[black] opacity-30 absolute top-0 bottom-0 left-[30%] right-0" />

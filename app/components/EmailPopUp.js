  ...
  return (
    <div className="fixed top-0 left-0 bottom-0 right-0 z-40 flex justify-center items-center">
      <div
        ...
        className="absolute top-0 left-0 bottom-0 right-0 opacity-50 bg-[black]"
      />
        ...
        <div className="h-[100%] overflow-auto">
          <div className="flex justify-center">
            <div className="w-[100%] lg:w-[213px] h-[90px] relative mb-[20px] lg:mb-[54px] lg:mx-auto">
              <LazyImage src="/logo-full.svg" alt="dk glass logo" />
            </div>
          </div>
          <div className="maincontent  ml-[26px]">
            <div>
              ...
              <p className="text-[14px] text-[#707070]">
                I assure you that we will find the best option for your
                projects, adding elegance and functionality to your spaces with
                our accessories.
              </p>
            </div>

...
const WhyUs = () => (
  <div className="flex mb-[100px]">
    ...
    <div className="w-[50%] border-l-[60px] border-l-dk-secondary p-[26px] pr-[76px] hidden lg:block">
      ...
      <p className="text-[#9A9A9A] text-[14px] mt-[54px]">En nuestra empresa, nuestro objetivo principal es alcanzar un crecimiento continuo y sostenible. Nos esforzamos por brindar  Services de calidad que no solo satisfagan las necesidades de nuestros clientes, sino que también tengan un impacto positivo en nuestro entorno natural.
